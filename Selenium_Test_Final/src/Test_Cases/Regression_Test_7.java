...
static WebDriver driver = new ChromeDriver();
	...
	public static void clickProfileButton()
	{
		...
		if(driver.getCurrentUrl().equals("https://korpa.ba/mojakorpa"))
		{
			System.out.println("7)Validation - We landed on right page (Korpa My profile page) - ✓");
		}
		else
		{
	...
	public static void switchingLanguage()
	{
		...
		if(driver.findElement(By.xpath("//*[@id=\"myTabContent\"]/div/form/h6")).getText().equals("Menus are currengly on English"))
		{
			System.out.println("8)Validation - Button was clicked  - ✓");
		}
		else
		{
			System.out.println("8)Validation - Error , button was not clicked - X");
		}
	}
}