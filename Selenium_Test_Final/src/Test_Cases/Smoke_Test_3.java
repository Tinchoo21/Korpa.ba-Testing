...
public class Smoke_Test_3 {
	...
	public static void clickingItemCategoryPage()
	{
		...
		{
			System.out.println("8)Validation - We landed on right page (KFC shop page) - ✓");
		}
		else
		{
	...
	public static void browsingItemsFromStore()
	{
		PartnerPage.itemsBrowse(driver).click();
	
		if(driver.findElement(By.xpath("//*[@id=\"food_list\"]/li[2]/a")).getAttribute("class").equals("nav-link active"))
		{
			System.out.println("9)Validation - Selection was successful  - ✓");
		}
		else
		{
			System.out.println("9)Validation - Error , Selection was not successful - X");
		}
	}
