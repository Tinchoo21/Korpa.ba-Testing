...
public class  Regression_Test_3 {
	...
	public static void inputingRegistrationForm()
	{
		...
		if(RegistrationPage.imeInputField(driver).getAttribute("value").equals("Adam"))
		{
			System.out.println("3)Validation - We inputed correct name (Adam) - ✓");
		}
		else
		{
		...
		RegistrationPage.phoneNumInputField(driver).sendKeys("062abc356");
		if(RegistrationPage.phoneNumInputField(driver).getAttribute("value").equals("062abc356"))
		{
			System.out.println("5)Validation - We inputed correct phone number (062abc356) -✓");
		}
		else
		{
