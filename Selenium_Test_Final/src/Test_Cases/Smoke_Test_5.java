...
static WebDriver driver = new ChromeDriver();
		...
		public static void clickingCheckoutBtn()
		{
			...
			if(driver.getCurrentUrl().equals("https://korpa.ba/nakasu"))
			{
				System.out.println("10)Validation -  We landed on right page (Korpa Checkout page)  - ✓");
			}
			else
			{
				System.out.println("10)Validation - Error , page is not correct- X");
			}
