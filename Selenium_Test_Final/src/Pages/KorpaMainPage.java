...
public class KorpaMainPage {
	...
	public static WebElement Prijavi_se_Button(WebDriver driver) {
		 ...
		 element = driver.findElement(By.xpath("//*[@id=\"navbarNavDropdown\"]/ul/li[2]/a"));
		return element;
	}
	
	public static WebElement ItemFromMostPopularCategory(WebDriver driver) {
		
		 element = driver.findElement(By.xpath("/html/body/section[2]/div/div[2]/div[1]/div/div[27]/div/div/a"));
